...
<body id="container">
    <form id="form1" runat="server">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0" id="centerAll">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Våra Tjänster
                        </a>
         ...
         <div class="bg"></div>
          <div class="centered">
                  <p id="wlcp">Välkommen till Eco Biltvätt</p>
