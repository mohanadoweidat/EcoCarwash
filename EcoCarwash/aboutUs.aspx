        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                 <%
                     ...
                     var Images = GetDBValue("tblImages", "ImageData");
                     bool found = false;
                     for (int i = 0; i < Images.Length; i++)
                     {
                         found = true;
                         string data = Convert.ToBase64String(Images[i] as byte[]);
                         Response.Write("<div class=\"swiper-slide\"> <img src=\"data:image/;base64," + data + "\"/></div>");
                     }

                     if (!found)
                     {
                          Response.Write("<div class=\"swiper-slide\"> <img style=\"width:100%; border-radius:10px;\" src=\"Images/no-image.png\"/></div>");
                     }
                  %>   
             </div>
